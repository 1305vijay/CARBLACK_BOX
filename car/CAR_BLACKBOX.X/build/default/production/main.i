...
void main()
{
    unsigned char screen_mode = 0x01;
    ...
    while(1){
        ...
        else if(key == 0x3B && gr > 0)
        {
            gr--;
            strcpy(event, gear[gr]);
            log_event(event, speed);
        }
        else if((key == 0x37 || key == 0x2F ) && screen_mode == 0x01)
        {
        ...
        else if(screen_mode == 0x03 && key == 0xBB)
        {
        ...
        switch(screen_mode)
        {
            ...
            case 0x66:
                ...
                if(view_log(key, start_flag) == 0xD2)
                    screen_mode = 0x03;
            ...
            case 0x88:
                ...
                if(download_log(start_flag) == 0xC1)
                {
            ...
            case 0X99:
                ...
                if (set_time_log(key, start_flag) == 0xC1)
                {
                    _delay((unsigned long)((3000)*(20000000/4000.0)));
                    clear_display();
                    screen_mode = 0x01;
            ...
            case 0XAA:
                ...
                if (change_passwd(key, start_flag) == 0xC1)
                {
                    clear_display();
                    TMR2ON = 0;
                    screen_mode = 0x01;
